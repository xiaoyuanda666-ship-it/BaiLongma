// BLM Icon Component - Lucide Icons Web Component
// 统一的矢量图标系统，支持主题适配、动画和可访问性
...
const ICONS = {
  ...
  'volume-2': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>',
  ...
  minimize: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6"/><path d="M20 10h-6V4"/><path d="M14 10l7-7"/><path d="M3 21l7-7"/></svg>',
  ...
  'thermometer-snowflake': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h20"/><path d="M12 2v20"/><path d="m20 16-4-4 4-4"/><path d="m4 8 4 4-4 4"/><path d="m16 4-4 4-4-4"/><path d="m8 20 4-4 4 4"/></svg>',
  'thermometer-sun': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"/></svg>',
...
class BlmIcon extends HTMLElement {
  static get observedAttributes() {
    return ['name', 'size', 'color', 'stroke-width', 'class'];
  }
  ...
  render() {
    ...
    if (!name) {
      console.warn('[BlmIcon] Missing required "name" attribute');
    ...
    if (!iconSvg) {
      console.warn(`[BlmIcon] Icon "${name}" not found in ICONS mapping`);
      this.shadowRoot.innerHTML = '';
      return;
    }
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        :host([animate="spin"]) svg {
          animation: spin 1s linear infinite;
        }
        :host([animate="pulse"]) svg {
...
customElements.define('blm-icon', BlmIcon);

// 导出 ICONS 映射表供其他模块使用
export { ICONS, BlmIcon };
